...
/****** Object:  Table [dbo].[OnlinePedestrians]    Script Date: 06/02/2014 08:10:22 ******/
SET ANSI_NULLS ON
GO
...
CREATE TABLE [dbo].[OnlinePedestrians](
	...
	[Longitude] [float] NULL,
	[Altitude] [float] NULL,
 CONSTRAINT [PK_OnlinePedestrians] PRIMARY KEY NONCLUSTERED 
(
	[Id] ASC
)WITH (PAD_INDEX  = OFF, STATISTICS_NORECOMPUTE  = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS  = ON, ALLOW_PAGE_LOCKS  = ON) ON [PRIMARY]
) ON [PRIMARY]
...
ALTER TABLE [dbo].[OnlinePedestrians] ADD  DEFAULT (newid()) FOR [Id]
GO
...
/****** Object:  Table [dbo].[OnlineDrivers]    Script Date: 06/02/2014 14:39:41 ******/
SET ANSI_NULLS ON
GO
...
CREATE TABLE [dbo].[OnlineDrivers](
	...
	[Longitude] [float] NULL,
	[Altitude] [float] NULL,
 CONSTRAINT [PK_OnlineDrivers] PRIMARY KEY NONCLUSTERED 
(
	[Id] ASC
)WITH (PAD_INDEX  = OFF, STATISTICS_NORECOMPUTE  = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS  = ON, ALLOW_PAGE_LOCKS  = ON) ON [PRIMARY]
) ON [PRIMARY]
